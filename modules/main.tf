...
module "firewall" {
  source = "./contos/platform/connectivity/securityservices/firewall"
...
module "application_security_group" {
 source = "./contos/platform/connectivity/securityservices/ASG"
 resource_group_name                                        = var.resource_group_name
 resource_group_location                                    = var.resource_group_location
 virtual_network_name                                       = var.virtual_network_name
...
module "application_gateway" {
  source = "./contos/platform/connectivity/securityservices/APPGW"
  resource_group_name                                       = var.resource_group_name
  resource_group_location                                   = var.resource_group_location
  virtual_network_name                                      = var.virtual_network_name
...
module "log-analytics" {
  source = "./contos/platform/connectivity/securityservices/log-analytics"
  resource_group_name                                       = var.resource_group_name
  resource_group_location                                   = var.resource_group_location
...
module "securitycenter" {
  source = "./contos/platform/connectivity/securityservices/securitycenter"
  resource_group_name                                       = var.resource_group_name
  resource_group_location                                   = var.resource_group_location
